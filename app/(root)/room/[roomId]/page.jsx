...
export default function RoomPage() {
	...
	// Room was destroyed
	useEffect(() => {
		if (!isInRoom && room === null && roomInfo && !pageLoading && !loading && user) {
	...
	}, [isInRoom, room, roomInfo, pageLoading, loading, user, roomId, fetchRoom, router]);
	...
	if (!roomInfo && !loading) {
		return (
			<div className="flex flex-col items-center justify-center min-h-[50vh] px-4 text-center">
				...
				<h2 className="text-lg md:text-xl font-bold text-white mb-2">Room Not Found</h2>
	...
	if (!user) {
		return (
			<div className="flex flex-col items-center justify-center min-h-[50vh] px-4 text-center">
				...
				<h2 className="text-lg md:text-xl font-bold text-white mb-2">Login Required</h2>
				<p className="text-white/50 text-sm md:text-base mb-6">

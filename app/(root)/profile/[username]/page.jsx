...
export default function ProfilePage({ params }) {
  ...
  if (loading) {
    return (
      <div className="container mx-auto py-10 px-4 md:px-0 animate-pulse-slow">
        <div className="flex flex-col items-center md:items-start md:flex-row gap-6 mb-10 border-b pb-10 border-white/10">
          <Skeleton
            circle
            className="h-32 w-32 shrink-0"
          />
          <div className="text-center md:text-left pt-2 space-y-3 w-full">
            ...
            <Skeleton className="h-9 w-32 mx-auto md:mx-0 rounded-lg" />
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {Array.from({ length: 8 }).map((_, index) => (
              <div
                key={index}
                className="space-y-3 rounded-lg bg-secondary/20 border border-white/5 p-3">
    ...
    <div className="container mx-auto py-10 px-4 md:px-0">
      <div className="flex flex-col items-center md:items-start md:flex-row gap-6 mb-10 border-b pb-10 border-white/10">
        ...
        <div className="text-center md:text-left pt-2">
          ...
          {isOwner && <p className="text-muted-foreground">{profile.email}</p>}

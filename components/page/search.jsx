	...
	return (
		<div
			...
			{open && (trimmed.length > 0 || recent.length > 0) && (
				<div className="fixed left-3 right-3 top-[56px] mt-0 md:absolute md:top-full md:left-0 md:right-0 md:mt-3 bg-popover border border-border rounded-2xl shadow-2xl p-2 z-[60] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
					<div className="p-2">
						{loading && (

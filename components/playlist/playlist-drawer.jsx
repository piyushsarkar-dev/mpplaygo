...
export function PlaylistDrawer({ children }) {
  ...
  const handleTogglePublic = async () => {
    ...
    if (error) {
      ...
      toast.success(
        newPublicState ? "Playlist is now public" : "Playlist is now private",
      );
                ...
                <div className="flex items-center gap-4">
                  <div className="w-20 h-20 rounded-xl overflow-hidden shadow-xl ring-1 ring-white/20">
                    {(
                      ...
                      selectedPlaylist.thumbnails.length > 0
                    ) ?
                      <div className="grid grid-cols-2 gap-0.5 h-full w-full bg-black">
                        {[0, 1, 2, 3].map((index) => (
                          <div
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 flex-wrap">
                      <div
                        className={`flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-semibold ${selectedPlaylist.is_public ? "bg-green-500/20 text-green-400 ring-1 ring-green-500/40" : "bg-white/10 text-white/70"}`}>
              ...
              <div className="flex flex-col gap-1 pb-6">
                ...
                {playlistSongs.map((song, index) => (
                  <div
                    ...
                    <div className="w-9 text-center text-sm text-white/50 font-semibold group-hover:hidden">
                      {index + 1}
                    </div>
                    <button
                    ...
                    <button
                      ...
                      <p className="text-white font-semibold truncate text-sm group-hover:text-primary transition">
                        {song.song_title}
                      </p>

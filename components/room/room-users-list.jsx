          ...
          {sortedMembers.map((member) => {
            ...
            return (
              <div
                ...
                <Link
                  href={`/profile/${encodeURIComponent(member.username || member.user_id)}`}
                  className="flex min-w-0 flex-1 items-center gap-3 rounded-xl px-1 py-1 text-left transition hover:bg-white/[0.04]">
